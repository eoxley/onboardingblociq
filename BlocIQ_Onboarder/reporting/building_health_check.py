...
class BuildingHealthCheckGenerator:
    """Professional Building Intelligence PDF Report Generator V2"""
    
    def __init__(self, supabase_client=None, branding_config_path=None):
        self.supabase = supabase_client
        self.engine = None
        self.building_data = {}
        # branding_config_path kept for compatibility (not used in V2)
    ...
    def generate_report(self, building_id: str, output_dir: str = 'reports', local_data: Dict = None) -> str:
        ...
        # Generate PDF
        pdf_filename = "building_health_check.pdf"  # Standard filename
    ...
    def _build_cover_page(self) -> List:
        ...
        # BlocIQ Logo (if available)
        logo_path = Path(__file__).parent.parent / 'assets' / 'logo-header.png'
        if logo_path.exists():
            try:
            ...
            # Text-based BlocIQ branding
            blociq_title = Paragraph(
                '<para alignment="center" fontSize="28" fontName="Helvetica-Bold" textColor="#5E48E8">BlocIQ</para>',
        ...
        # BlocIQ Branding & Disclaimer
        footer_p = Paragraph(
            '<para alignment="center" fontSize="10" textColor="#6C757D">'
            '<i>Prepared by BlocIQ Onboarder AI</i><br/>'
            'Intelligent Building Management Platform<br/><br/>'
            '<font size="8" textColor="#999999">'
            '⚠️ AI-Generated Report: This document was automatically generated by BlocIQ\'s artificial intelligence system.<br/>'
            'Data has been extracted and analyzed using machine learning algorithms.<br/>'
    ...
    def _build_appendix(self) -> List:
        ...
        stats_text = (
            ...
            f"Report Version: 2.0.0<br/>"
        )
        elements.append(Paragraph(stats_text, self.styles['BodyText']))
        elements.append(Spacer(1, 0.3*inch))
        
        # AI Generation Disclaimer
        elements.append(Paragraph("AI Generation & Data Disclaimer", self.styles['SubSection']))
        
        disclaimer_text = (
            "<b>⚠️ Automated Intelligence System</b><br/>"
            "This report was automatically generated by BlocIQ's artificial intelligence platform using advanced "
            "machine learning algorithms and natural language processing. The system has analyzed building documents, "
            "compliance records, contracts, and financial data to produce this intelligence report.<br/><br/>"
            
            "<b>Data Extraction & Analysis</b><br/>"
            "• Document parsing: OCR and AI-powered text extraction<br/>"
            "• Data categorization: Machine learning classification models<br/>"
            "• Risk assessment: Rule-based and statistical analysis<br/>"
            "• Scoring methodology: Weighted multi-factor algorithm<br/><br/>"
            
            "<b>Important Notices</b><br/>"
            "• <b>Accuracy:</b> While BlocIQ's AI system is highly accurate, automated extraction may contain errors. "
            "Please verify critical information against source documents.<br/>"
            "• <b>Compliance:</b> This report does not constitute legal or regulatory advice. "
            "Consult qualified professionals for compliance matters.<br/>"
            "• <b>Decisions:</b> Use this report as an intelligence tool to inform decisions, "
            "not as the sole basis for critical actions.<br/>"
            "• <b>Updates:</b> Building data changes over time. Generate fresh reports regularly "
            "to maintain accurate intelligence.<br/><br/>"
            
            "<font size='8' textColor='#666666'>"
            "© 2025 BlocIQ Ltd. All rights reserved. BlocIQ Building Intelligence Platform. "
            "For questions or support, contact your BlocIQ representative."
            "</font>"
        )
...
def generate_building_intelligence_report(building_id: str, output_dir: str, local_data: Dict = None) -> str:
    """
    Generate Building Intelligence Report (V2)
...
def generate_building_health_check(building_id: str, output_dir: str, local_data: Dict = None) -> str:
    """Legacy function name - calls V2 system"""
    return generate_building_intelligence_report(building_id, output_dir, local_data)
